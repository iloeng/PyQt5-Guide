...
from Ch19.s19_12.graphicsview import CGraphicsView
from Ch19.s19_12.splashscreen import CSplashScreen
...
class CMainWindow(QMainWindow):
    ...
    def __init__(self, splashScreen, parent=None):
        ...
        self.initialize()
        self.setWindowTitle('拷贝、复制、粘贴')
        self.setMinimumSize(160, 160)
        self.resize(480, 320)

    def initialize(self):
        # 构建视图对象
        self.graphicsView = CGraphicsView(self)
        self.scene = QGraphicsScene(self)
        self.graphicsView.setScene(self.scene)
        rct = QRectF(0, 0, 400, 400)
        self.scene.setSceneRect(rct)
    ...
    def slot_addRect(self):
        self.graphicsView.addRect()

    def slot_addEllipse(self):
        self.graphicsView.addEllipse()
