...
from PyQt5.QtCore import Qt, QFile, QTextStream, pyqtSignal, QThread, QSize

from Ch19.s19_10.textedit import CTextEdit
from Ch19.s19_10.splashscreen import CSplashScreen
    ...
    def openFile(self, strs):
        if strs.strip():
            ...
            if self.textEdit.openFile(fileName):
                ...
                self.infoLabel.setText("file can not open!")
